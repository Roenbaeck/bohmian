...
\keywords{Bohmian mechanics, Madelung hydrodynamics, seam geometry, quantum potential, quadratic differentials, nodal singularities}
...
\noindent\textbf{Motivation (heuristic).}
...
\subsection{Harmonic-oscillator node geometry (structure only)}
...
\subsection{Vortex test (nonzero current; quantitative evidence)}
...
\subsection{Shifted vortex test (symmetry-broken test)}
...
\noindent\textbf{Outlook.} Concrete directions suggested by this dictionary include:
\begin{itemize}
